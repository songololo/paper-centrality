...
# Resolve all on-disk paths relative to the repository root so the script works
# regardless of the current working directory.
repo_root = pathlib.Path(__file__).resolve().parents[1]

# %%
images_path = repo_root / "paper/plots"
tables_path = repo_root / "paper/tables"

# %%
survey_data = gpd.read_file(repo_root / "data/edm_2018_viajes.csv")
survey_zones = gpd.read_file(repo_root / "data/zones_ZT1259.gpkg")
...
mad_gpd = gpd.read_file(repo_root / "temp/dataset.gpkg")

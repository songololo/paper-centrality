...
Network, landuse, and travel survey data are prepared for Madrid, Spain. Access to the input datasets and further detailed preparatory notes are provided in the data repository.
...
Land uses are derived from an open dataset for Madrid, consisting of 153,953 premises classed according to a schema comprising approximately 80 landuse categories \cite{madrid_premises}.
...
The Regional Transport Consortium of Madrid travel survey data contains approximately 200,000 origin-destination journeys encompassing approximately 1250 regions within Greater Madrid, including travel mode and travel reasons information \cite{crtm_edm_2020,crtm_zones_2020}.

...
Localised analysis is now common practice. Throughout this paper, we use the term `localised' regardless of the distance threshold. Critically, in localised analysis the number of reachable nodes varies by origin---this is the condition under which different closeness formulations diverge in behaviour.
